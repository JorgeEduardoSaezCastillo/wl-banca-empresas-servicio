...
/**
 * <p>Clase Java para consMtoMaxOut complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="consMtoMaxOut">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="cod_estado" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="montoMaxDto" type="{http://portal.ws.bice.cl/}montoMaxDto" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "consMtoMaxOut", propOrder = {
    "codEstado",
    "montoMaxDto",
    "msgResult"
})
public class ConsMtoMaxOut {

    @XmlElement(name = "cod_estado")
    protected int codEstado;
    @XmlElement(nillable = true)
    protected List<MontoMaxDto> montoMaxDto;
    ...
    /**
     * Gets the value of the montoMaxDto property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the montoMaxDto property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMontoMaxDto().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MontoMaxDto> getMontoMaxDto() {
        if (montoMaxDto == null) {
            montoMaxDto = new ArrayList<MontoMaxDto>();
        }
        return this.montoMaxDto;
    }
