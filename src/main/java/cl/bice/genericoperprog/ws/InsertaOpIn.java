...
/**
 * <p>Clase Java para insertaOpIn complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="insertaOpIn">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="IN_COD_SERVICIO" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_ESTADO" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_ACCION" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_NOM_REGISTRO" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_RUT_REGISTRO" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_FEC_REGISTRO" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_HR_REGISTRO" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_FEC_CURSE" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_HR_CURSE" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_FEC_PRESCRIPCION" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_HR_PRESCRIPCION" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_RUT_CLIENTE" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_NOM_CLIENTE" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_NUM_OPER_TRF" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_NUM_NOMINA" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_NUM_OP_ANULA" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="IN_COD_EJECUTOR" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "insertaOpIn", propOrder = {
    "incodservicio",
    "inestado",
    "inaccion",
    "innomregistro",
...
public class InsertaOpIn {

    @XmlElement(name = "IN_COD_SERVICIO", required = true)
    protected String incodservicio;
    @XmlElement(name = "IN_ESTADO", required = true)
    protected String inestado;
    @XmlElement(name = "IN_ACCION", required = true)
    protected String inaccion;
    @XmlElement(name = "IN_NOM_REGISTRO", required = true)
    protected String innomregistro;
    @XmlElement(name = "IN_RUT_REGISTRO", required = true)
    protected String inrutregistro;
    @XmlElement(name = "IN_FEC_REGISTRO", required = true)
    protected String infecregistro;
    @XmlElement(name = "IN_HR_REGISTRO", required = true)
    protected String inhrregistro;
    @XmlElement(name = "IN_FEC_CURSE", required = true)
    protected String infeccurse;
    @XmlElement(name = "IN_HR_CURSE", required = true)
    protected String inhrcurse;
    @XmlElement(name = "IN_FEC_PRESCRIPCION", required = true)
    protected String infecprescripcion;
    @XmlElement(name = "IN_HR_PRESCRIPCION", required = true)
    protected String inhrprescripcion;
    @XmlElement(name = "IN_RUT_CLIENTE", required = true)
    protected String inrutcliente;
    @XmlElement(name = "IN_NOM_CLIENTE", required = true)
    protected String innomcliente;
    @XmlElement(name = "IN_NUM_OPER_TRF", required = true)
    protected String innumopertrf;
    @XmlElement(name = "IN_NUM_NOMINA", required = true)
    protected String innumnomina;
    @XmlElement(name = "IN_NUM_OP_ANULA", required = true)
    protected String innumopanula;
    @XmlElement(name = "IN_COD_EJECUTOR", required = true)
