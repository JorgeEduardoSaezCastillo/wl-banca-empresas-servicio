...
/**
 * <p>Clase Java para BalanceProcessRequestType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="BalanceProcessRequestType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "BalanceProcessRequestType", propOrder = {
    "rutCliente"
})
@XmlRootElement(name="BalanceEnLineaRequest")
public class BalanceProcessRequestType {
