 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.bice.cl/wsdl}CHEQUES" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "INFOCHEQUES")
public class INFOCHEQUES {

    @XmlElement(name = "CHEQUES", required = true)
    protected List<CHEQUES> cheques;
