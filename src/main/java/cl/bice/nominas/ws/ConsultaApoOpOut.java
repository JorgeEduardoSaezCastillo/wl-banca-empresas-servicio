 ...
 *         &lt;element name="firmaOpDto" type="{http://ws.nominas.bice.cl/}firmaOpVo" maxOccurs="unbounded" minOccurs="0"/>
...
public class ConsultaApoOpOut {
    ...
    protected List<FirmaOpVo> firmaOpDto;
     ...
     * 
     */
    public List<FirmaOpVo> getFirmaOpDto() {
        if (firmaOpDto == null) {
            firmaOpDto = new ArrayList<FirmaOpVo>();
        }
